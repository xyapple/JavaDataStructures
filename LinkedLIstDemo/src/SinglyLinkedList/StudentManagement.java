...
public class StudentManagement {
    ...
    private static SinglyLinkedList<Student> studentList = new SinglyLinkedList<Student>();
...
// Enter User GPA
    ...
    private static void removeStudent() throws IOException {
        ...
        SinglyLinkedList<Student> newSList2 = new SinglyLinkedList();  //create a new linked list newSList2
        SinglyLinkedList<Student> newSList2D = new SinglyLinkedList();  //create a new linked list newSList2D
        //Clone the newSlist2
        try {
